...
def footer_social_page():
    ...
    return render_template(
        ...
        footer_copyright_text=_setting("footer_copyright_text", "Todos os direitos reservados - 2009-2026 - PORTALPARANAATUAL.COM.BR"),
        instagram_url=_setting("instagram_url", ""),
        facebook_url=_setting("facebook_url", ""),
        youtube_url=_setting("youtube_url", ""),
        x_url=_setting("x_url", ""),
...
def save_footer_social():
    ...
    _save_setting("footer_copyright_text", (request.form.get("footer_copyright_text", "") or "").strip() or "Todos os direitos reservados - 2009-2026 - PORTALPARANAATUAL.COM.BR")
