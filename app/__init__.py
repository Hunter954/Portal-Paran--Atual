...
def _ensure_defaults():
    ...
    for key, value in [
        ("live_embed_html", ""),
        ("logo_url", ""),
        ("site_name", os.getenv("SITE_NAME", "Portal Paraná Atual")),
        ("favicon_url", ""),
        ("default_share_image", ""),
        ("site_tagline", "Notícias do Paraná em tempo real"),
        ("default_meta_description", "Últimas notícias do Paraná, Brasil, cidade, economia, educação, esporte, policial e política."),
        ("facebook_app_id", ""),
